#!/bin/sh
# ========================================
GITHUB_ACCOUNT=rautskaya
WS_DIR=Automation
REPO_NAME=TitleValidationCSV
APP_VERSION=1.1
MAIN_CLASS=core.TitleValidationCSV.SeleniumCSVThrows
ARGS_01=
# ========================================
# ========================================
# GITHUB_ACCOUNT=$1
...
if which git >/dev/null 2>&1 ; then git --version &>gv.txt; grep "git version" gv.txt | awk '{print $1,$3}'; else echo Git not installed; return; fi
...
java -cp $HOME/$WS_DIR/$REPO_NAME/$REPO_NAME/target/$REPO_NAME-$APP_VERSION-jar-with-dependencies.jar $MAIN_CLASS $ARGS_01